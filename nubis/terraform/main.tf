...
data "aws_iam_policy_document" "ci_deploy" {
  ...
  statement {
    ...
    actions = [
      ...
      "acm:CreateCloudFrontOriginAccessIdentity",
      "acm:CreateDistribution",
      "acm:CreateDistributionWithTags",
      "acm:CreateInvalidation",
      "acm:CreateStreamingDistribution",
      "acm:CreateStreamingDistributionWithTags",
      "acm:DeleteCloudFrontOriginAccessIdentity",
      "acm:DeleteDistribution",
      "acm:DeleteStreamingDistribution",
      "acm:GetCloudFrontOriginAccessIdentity",
      "acm:GetCloudFrontOriginAccessIdentityConfig",
      "acm:GetDistribution",
      "acm:GetDistributionConfig",
      "acm:GetInvalidation",
      "acm:GetStreamingDistribution",
      "acm:GetStreamingDistributionConfig",
      "acm:ListCloudFrontOriginAccessIdentities",
      "acm:ListDistributions",
      "acm:ListDistributionsByWebACLId",
      "acm:ListInvalidations",
      "acm:ListStreamingDistributions	",
      "acm:ListTagsForResource",
      "acm:TagResource",
      "acm:UntagResource",
      "acm:UpdateCloudFrontOriginAccessIdentity",
      "acm:UpdateStreamingDistribution",
      "ec2:createTags",
      "ec2:deleteTags",
      "ec2:CreateSecurityGroup",
