...
package { 'aufs-tools':
  ensure => '1:3.2+20130722-1.1ubuntu1',
}
package { 'awscli':
...
package { 'docker-ce':
  ensure => '5:18.09.6~3-0~ubuntu-xenial',
}
...
package { 'libavahi-client3':
  ensure => '0.6.32~rc+dfsg-1ubuntu2.3',
}
...
package { 'libgraphite2-3':
  ensure => '1.3.10-0ubuntu0.16.04.1',
}
...
package { 'libgtk2.0-0':
  ensure => '2.24.30-1ubuntu1.16.04.2',
}
...
package { 'libpcsclite1':
  ensure => '1.8.14-1ubuntu1.16.04.1',
}
package { 'libperl5.22':
...
package { 'libsndfile1':
  ensure => '1.0.25-10ubuntu0.16.04.2',
}
...
package { 'libxcursor1':
  ensure => '1:1.1.14-1ubuntu0.16.04.2',
}
package { 'libxdamage1':
  ensure => '1:1.1.4-2',
}
...
package { 'openjdk-8-jdk':
  ensure => '8u212-b03-0ubuntu1.16.04.1',
}
...
package { 'x11-common':
  ensure => '1:7.7+13ubuntu3.1',
}
package { 'x11proto-core-dev':
  ensure => '7.0.31-1~ubuntu16.04.2',
}
package { 'x11proto-input-dev':
  ensure => '2.3.1-1',
}
package { 'x11proto-kb-dev':
  ensure => '1.0.7-0ubuntu1',
}
package { 'xauth':
